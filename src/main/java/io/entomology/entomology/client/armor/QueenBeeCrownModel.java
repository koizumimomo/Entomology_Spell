...
public class QueenBeeCrownModel extends GeoModel<SwarmArmorItem>
{
    @Override
    public ResourceLocation getModelResource(SwarmArmorItem object)
    {
        return ResourceLocation.fromNamespaceAndPath(EntomologyMod.MODID, "geo/queen_bee_crown.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(SwarmArmorItem object)
    {
        return ResourceLocation.fromNamespaceAndPath(EntomologyMod.MODID, "textures/armor/queen_bee_crown.png");
    }
